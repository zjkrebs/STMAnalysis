% function combine_spec7(s1,s2,v1,v2,v3,v4,sn)
...
xxx4=length([v1 v2 v3 v4]);
        plot(xz,mean(m(1:xxx1,:)),'b',xz,mean(m((xxx1+1):xxx2,:)),'b:','linewidth',2)
        plot(xz,mean(m((xxx2+1):xxx3,:)),'r','linewidth',2)
        plot(xz,mean(m((xxx3+1):xxx4,:)),'r:','linewidth',2)
        hold off
set(gca,'fontsize',18)
grid
axis tight
