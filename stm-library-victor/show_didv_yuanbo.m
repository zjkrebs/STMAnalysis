...
for i=1:n1
    for j=1:n2
        tf14(i,j)=0.0061*(tf14(i,j)*tf14(i,j)); % convert Dirac point Energy (unit meV) to local charge carrier density (unit 1e10 cm^-2) 
...
for i=1:n1
    for j=1:n2
        tb14(i,j)=0.0061*(tb14(i,j)*tb14(i,j)); % convert Dirac point Energy (unit meV) to local charge carrier density (unit 1e10 cm^-2) 
                                                %using graphene linear relation
    end
end
pcolor(xx,yy,tb14)
