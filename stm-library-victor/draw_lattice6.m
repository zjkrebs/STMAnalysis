...
function draw_lattice6(x0,y0,nl)
...
for i=0:nl,
    y1=x*sl1+b1+deb1*i;
    y2=x*sl1+b1-deb1*i;
    plot(x,y1,'g',x,y2,'g','linewidth',.6)
%    if i==1,
...
yy2=sl1*xx2+bb1;
yy3=sl3*xx3+bb3;
patch([xx1 xx2 xx3],[yy1 yy2 yy3],'b','erasemode','background','edgecolor','g')
...
patch([xx1 xx2 xx3],[yy1 yy2 yy3],'r','erasemode','background','edgecolor','g')
bb1=b1+11*deb1;
bb2=b2-7*deb2;
bb3=b3+5*deb3;
xx1=(bb3-bb1)/(sl1-sl3);
...
yy3=sl3*xx3+bb3;
patch([xx1 xx2 xx3],[yy1 yy2 yy3],'b','erasemode','background','edgecolor','g')
%plot(xx1,yy1,'*',xx2,yy2,'*',xx3,yy3,'*','markersize',12)
hold off