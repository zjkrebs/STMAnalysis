...
function combine_spec4(s1,s2,v1,v2,v3,v4,v5,v6)
p=strrep(cd,'\','\\');
...
xxx6=length([v1 v2 v3 v4 v5 v6]);
        ...
        plot(xz,mean(m((xxx2+1):xxx3,:)),'b:','linewidth',2.5)
        plot(xz,mean(m((xxx3+1):xxx4,:)),'r',xz,mean(m((xxx4+1):xxx5,:)),'r:','linewidth',1.5)
        plot(xz,mean(m((xxx5+1):xxx6,:)),'r:','linewidth',2.5)
